...
"$cloudflarest_path" -o "$output_file" -dd -t 10 -sl 5 -dn 5 -tll 40 -tl 200 -tlr 0.0 -cfcolo ATL,LAX,ORD,JFK,SFO,MIA,DFW,SEA,EWR,PHX,BUF
#"$cloudflarest_path" -o "$output_file" -sl 5 -dn 5 -tll 40 -tl 200 -tlr 0.0
